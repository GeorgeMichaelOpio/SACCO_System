        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <h7 class="card-header">Select on any account to withdrawal money</h7>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="pages_withdraw_money.php?account_id=<?php echo $row->account_id; ?>&account_number=<?php echo $row->account_number; ?>&client_id=<?php echo $row->client_id; ?>"><i class="ri-pencil-line me-1"></i>Withdraw</a>
                            </div>
                          </div>
                        </td>
                      </tr>
