                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="pages_update_client_accounts.php?account_id=<?php echo $row->account_id; ?>"><i class="ri-pencil-line me-1"></i> Edit</a>
                              <a class="dropdown-item" href="pages_manage_acc_openings.php?deleteBankAcc=<?php echo $row->account_id; ?>"><i class="ri-delete-bin-6-line me-1"></i> Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
