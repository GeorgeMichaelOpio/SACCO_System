<ul class="menu-inner py-1">
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="pages_add_staff.php" class="menu-link">
          <div data-i18n="Add Staff">Add Staff</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="pages_manage_staff.php" class="menu-link">
    ...
    <ul class="menu-sub">
      ...
      <li class="menu-item">
        <a href="pages_manage_accs.php" class="menu-link">
          <div data-i18n="Manage Acc Type">Manage Acc Types</div>
        </a>
      </li>
      <li class="menu-item">
  ...
  <li class="menu-item">
    <a
      href="pages_transactions_engine.php"
      class="menu-link">
  ...
  <li class="menu-item">
    <a
      href="pages_system_settings.php"
      class="menu-link">
