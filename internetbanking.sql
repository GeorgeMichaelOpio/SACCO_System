...
(3, 'John Doe', '36756481', '9897890089', '127007 Localhost', 'johndoe@gmail.com', '903b21879b4a60fc9103c3334e4f6f62cf6c3a2d', '', 'iBank-CLIENT-8127'),
...
--
ALTER TABLE `ib_bankaccounts`
  MODIFY `account_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `ib_transactions`
  MODIFY `tr_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
COMMIT;
