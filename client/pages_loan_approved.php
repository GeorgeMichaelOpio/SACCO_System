...
if (isset($_GET['reject_loan'])) {
    ...
    $stmt->execute();
    if ($stmt) {
        $info = "Loan Rejected Successfully";
    } else {
        $err = "Please Try Again Later";
    }
    $stmt->close();
                                    ...
                                    <div class="table-responsive">
                                        <table id="export" class="table table-hover table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $client_id = $_SESSION['client_id'];
                                                // Get pending loans for a specific client
                                                $ret = "SELECT * FROM ib_loans WHERE ln_status = 'Approved' AND client_id = ? ORDER BY created_at DESC";
